...
const ECommerceGrowthCTA: React.FC = () => {
  return (
        ...
        <div className="max-w-8xl mx-auto bg-gradient-to-br from-[#001f54] to-[#001a47] rounded-3xl p-12 md:p-16 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
              Let's discuss your e-commerce goals and create a growth strategy that drives revenue and scales your business
            </p>
...
export default ECommerceGrowthCTA;
