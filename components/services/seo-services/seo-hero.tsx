    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 opacity-10 animate-float">
          <code className="text-green-400 text-sm">Google</code>
        </div>
        <div className="absolute top-40 right-20 opacity-10 animate-float-delay">
          <code className="text-blue-400 text-sm">Rankings</code>
        </div>
        <div className="absolute bottom-40 left-20 opacity-10 animate-float-delay-2">
          <code className="text-purple-400 text-sm">Traffic</code>
        </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="animate-on-scroll opacity-0 text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Boost your website's visibility with proven SEO strategies that drive organic traffic, increase rankings, and generate qualified leads.
          </p>
          ...
          <div className="animate-on-scroll opacity-0 mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: '300+', label: 'Websites Optimized' },
              { value: '#1', label: 'Average Ranking' },
