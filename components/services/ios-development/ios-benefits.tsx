  ...
  const benefits = [
    {
      ...
      description: 'Lightning-fast performance with native iOS code and optimizations',
      icon: '⚡',
      stat: '100%',
    },
    {
      title: 'App Store Presence',
      description: 'Get your app featured on the world\'s most trusted app marketplace',
      icon: '🏪',
      stat: '2M+',
    },
    {
      title: 'Premium User Experience',
      description: 'Deliver exceptional user experiences with Apple\'s design standards',
      icon: '✨',
      stat: '4.8★',
    },
    {
      title: 'Security & Privacy',
      description: 'Built-in security features and privacy protection for users',
      icon: '🔒',
      stat: '100%',
    },
    {
      title: 'Device Integration',
      description: 'Leverage iPhone and iPad features like camera, GPS, and sensors',
      icon: '📱',
      stat: '100%',
    },
    {
      title: 'Regular Updates',
      description: 'Keep your app updated with latest iOS features and improvements',
      icon: '🔄',
      stat: '24/7',
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Experience the benefits of native iOS app development
          </p>
        </div>
