    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 opacity-10 animate-float">
          <code className="text-green-400 text-sm">Facebook</code>
        </div>
        <div className="absolute top-40 right-20 opacity-10 animate-float-delay">
          <code className="text-blue-400 text-sm">Instagram</code>
        </div>
        <div className="absolute bottom-40 left-20 opacity-10 animate-float-delay-2">
          <code className="text-purple-400 text-sm">LinkedIn</code>
        </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="animate-on-scroll opacity-0 text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Boost your online presence with strategic social media marketing that engages audiences, builds communities, and drives real business results.
          </p>
